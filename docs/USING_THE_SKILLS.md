...
| **MUIOGO and your models** | The workspace the installer created: `~/muiogoai/MUIOGO`, with model data under `WebAPP/DataStorage/`. |
...
> Review the CLEWs Demo model in ~/muiogoai/MUIOGO/WebAPP/DataStorage
> for structure and data consistency

The skill runs its bundled checker. You can also run it yourself:

```bash
python3 .agents/skills/clews-model-review/audit.py --datastorage ~/muiogoai/MUIOGO/WebAPP/DataStorage "CLEWs Demo"
```
